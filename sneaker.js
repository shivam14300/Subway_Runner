let Sneaker = class {
    constructor(gl,pos,texture,r) {
        ...
        for(var i=0;i<36;i++)
        {
            this.positions.push(x+r*Math.cos((10.0*M_PI*i)/180));
            this.positions.push(l);
            this.positions.push(r*Math.sin((10.0*M_PI*i)/180));
            
            this.positions.push(x+r*Math.cos((10.0*M_PI*(i+1))/180));
            this.positions.push(l);
            this.positions.push(r*Math.sin((10.0*M_PI*(i+1))/180));
            
            this.positions.push(x+r1*Math.cos((10.0*M_PI*(i))/180));
            this.positions.push(-l/3);
        ...
        for(var i=0;i<36;i++)
        {
            ...
            this.positions.push(x+r1*Math.cos((10.0*M_PI*(i+1))/180));
            this.positions.push(-l/3);
